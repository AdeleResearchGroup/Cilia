 ...
 *
 */
public abstract class MediatorElement extends Component {
	/**
	 * Reference to the mediator which contain this element. 
	 */
	private volatile MediatorComponent mediator;
	
	
	
	private final Object lockObject = new Object(); 
	
	public MediatorElement(String id, String type, String nspace,
	 ...
	 */
	public void setMediator(MediatorComponent mediator) {
		synchronized (lockObject) {
