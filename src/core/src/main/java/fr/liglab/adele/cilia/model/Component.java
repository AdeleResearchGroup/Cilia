 ...
 * 
 */
public class Component extends Observable implements IComponent {
	 ...
	 *            model representation properties.
	 */
	public Component(String id, String type, String nspace, Dictionary properties) {
	...
	/**
	 * @return the Type
	 * @deprecated Model must not have any relation with the implementation.
	 */
