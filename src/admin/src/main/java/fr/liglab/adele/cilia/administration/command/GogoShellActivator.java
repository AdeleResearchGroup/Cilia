...
/**
 * GogoShellActivator: Creates the adapter instance and bind it to the
 * cilia-admin chain.
 * 
...
public class GogoShellActivator implements ChainListener {
	...
	public void onAddingChain(Chain chain) {
        ...
        adapter = new AdapterImpl("gogo-command-adapter", "felix-admin-gogo-shell",
                "fr.liglab.adele.cilia", null,config, null, PatternType.IN_ONLY);
        //adapter = new AdapterImpl("gogo-command-adapter", "felix-admin-gogo-shell", "fr.liglab.adele.cilia", null, null, null,config, PatternType.IN_ONLY);
        mchain.add(adapter);
