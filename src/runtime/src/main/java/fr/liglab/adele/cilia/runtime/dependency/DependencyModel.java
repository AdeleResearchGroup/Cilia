...
public abstract class DependencyModel implements TrackerCustomizer {
	 ...
	 *            the LDAP filter
	 * @param comparator
	 *            the comparator object to sort references
	 * @param policy
	 *            the binding policy
	 * @param context
	 *            the bundle context (or service context)
	 * @param listener
	 *            the dependency lifecycle listener to notify from dependency
	 * @param ci
	 *            instance managing the dependency state changes.
	 */
	 ...
	 * 
	 * @param ref
	 *            the arriving service reference.
	 ...
	 * @param arg1
	 *            the service object if the service was already get
	 ...
	 *            the leaving service reference
	 * @param obj
	 *            the service object if the service was get
	 */
	 ...
	 * @param arg1
	 *            the service object if already get.
	 ...
	 * 
	 * @param ref
	 *            the service reference to inject.
	 */
	 ...
	 * 
	 * @param departs
	 *            the service leaving the matching set.
	 * @param arrivals
	 *            the service arriving in the matching set.
	 */
	 ...
	 * 
	 * @param isAggregate
	 *            the new aggregate attribute value.
	 */
	 ...
	 * 
	 * @param isOptional
	 *            the new optional attribute value.
	 */
	 ...
	 * @param context
	 *            the bundle context (to load the comparator class)
	 ...
	 * 
	 * @param specification
	 *            the specification class name to load
	 * @param context
	 *            the bundle context
	 * @return the class object for the given specification
	 * @throws ConfigurationException
	 *             if the class cannot be loaded correctly.
	 */
	 ...
	 * @throws ConfigurationException
	 *             if an unknown binding policy was described.
	 */
	 ...
	 * 
	 * @param String
	 *            policy the Element describing the dependency
	 * @return the policy attached to this dependency
	 * @throws ConfigurationException
	 *             if an unknown binding policy was described.
	 */
