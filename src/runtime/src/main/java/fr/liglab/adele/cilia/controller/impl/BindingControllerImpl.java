 ...
 * 
 */
public class BindingControllerImpl implements BindingController, TrackerCustomizer {
	/**
	 * Binding model to handle.
	 */
	private Binding modelBinding;

	private MediatorController sourceController;

	private MediatorController targetController;
	
	private final Object lockObject = new Object();

	public void setSourceController(MediatorController sourceController) {
		this.sourceController = sourceController;
	}

	public void setTargetController(MediatorController targetController) {
