...
import fr.liglab.adele.cilia.runtime.application.ApplicationImpl;
import fr.liglab.adele.cilia.runtime.dynamic.DynamicPropertiesImpl;
...
public class CiliaContextImpl implements CiliaContext {
	...
	private DynamicPropertiesImpl dynamicProperties = null;
	...
	public CiliaContextImpl(BundleContext bc) {
		...
		application = new ApplicationImpl(bcontext, container);
		dynamicProperties = new DynamicPropertiesImpl(bcontext, container);
	}
