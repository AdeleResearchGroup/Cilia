...
public class Const implements ConstModel {
	...
	/* 
	 * Trace runtime 
	 * INFO  = chain Start/Stop , mediator start/Stop 
	 * DEBUG = incoming messages on each mediator /adapter  
     */
	 ...
	 */
	public final static String LOGGER_STATE_VARIABLE="cilia.runtime.statevariable" ;
	/*
	 * Trace modifications 
	 */
