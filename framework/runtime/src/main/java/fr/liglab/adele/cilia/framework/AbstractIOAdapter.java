...
public abstract class AbstractIOAdapter {
     ...
     *
     * @param data Data to be passed to the chain.
     ...
     *
     * @param data Data to send to the first mediator.
     ...
     *
     * @param Data the data use to generate the key, this key will be associated
     *             to the data.
