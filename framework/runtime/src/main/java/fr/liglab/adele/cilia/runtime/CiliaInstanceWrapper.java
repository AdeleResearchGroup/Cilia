...
public class CiliaInstanceWrapper extends Observable implements CiliaInstance,
     ...
     * @param instanceName The name of the instance, this is not the iPOJO instance name,
     *                     is an abstract name.
     * @param filter       A filter to search the iPOJO factory which will create the
     *                     instance.
     * @param props        Properties used when creating the instance.
     * @param obs          The observer reference.
     */
