...
public class SchedulerHandler extends PrimitiveHandler implements ISchedulerHandler, Runnable {
     ...
     * @param metadata iPOJO metadata.
     * @throws ConfigurationException when there is an error configuring handler with the iPOJO.
     */
     ...
     *
     * @param dataSet Data set used to invoke process in mediator.
     * @return null.
     */
