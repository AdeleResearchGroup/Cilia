...
/**
 * This class help you to create Adapter specification at runtime.
 *
 * @author <a href="mailto:cilia-devel@lists.ligforge.imag.fr">Cilia Project Team</a>
 */
public class AdapterRuntimeSpecification extends AbstractMediatorSpecification {

    BundleContext context;

    private MediatorFactory factory;

    public AdapterRuntimeSpecification(String name, String namespace,
                                       String category) {
