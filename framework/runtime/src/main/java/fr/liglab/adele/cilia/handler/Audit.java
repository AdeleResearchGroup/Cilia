...
package fr.liglab.adele.cilia.handler;
...
public class Audit extends PrimitiveHandler {
	private final Logger logger = LoggerFactory.getLogger(Const.LOGGER_APPLICATION);
	...
	public void configure(Element metadata, Dictionary configuration)
		...
		Element[] elem = metadata.getElements("audit", "fr.liglab.adele.cilia.handler");
		...
		if (logger.isDebugEnabled()) {
			logger.debug("[Handler audit] Configuration Fields Set {}", fieldsSet);
			logger.debug("[Handler audit] Configuration Fields Get {}", fieldsGet);
			logger.debug("[Handler audit] Configuration prefix {}", fieldsPrefix);
		}
	}
	...
	public Object onGet(Object pojo, String field, Object o) {
		...
		logger.debug("[Handler audit] onGet {}", qualifiedField);
		return o;
	}
	...
	public void onSet(Object pojo, String field, Object newvalue) {
		...
		logger.debug("[Handler audit] onSet {}", qualifiedField);
	}
