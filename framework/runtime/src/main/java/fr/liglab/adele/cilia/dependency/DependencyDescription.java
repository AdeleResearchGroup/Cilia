...
public class DependencyDescription {
    ...
    public boolean isMultiple() {
        return m_dependency.isAggregate();
    }

    public boolean isOptional() {
        return m_dependency.isOptional();
    }

    public String getFilter() {
        return m_dependency.getFilter();
    }
    ...
    public boolean supportsNullable() {
        return m_dependency.supportsNullable();
    }

    public String getDefaultImplementation() {
        return m_dependency.getDefaultImplementation();
    }

    public int getPolicy() {
        return m_dependency.getBindingPolicy();
    }

    public String getComparator() {
        return m_dependency.getComparator();
    }

    public boolean isFrozen() {
        return m_dependency.isFrozen();
    }
    ...
    public List getServiceReferences() {
        return m_dependency.getServiceReferencesAsList();
    }
    ...
    public List getUsedServices() {
        return m_dependency.getUsedServiceReferences();
    }
