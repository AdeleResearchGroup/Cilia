...
public class CiliaContainerImpl implements CiliaContainer {
     ...
     *
     * @param chainId The chain identificator to localize.
     ...
     *
     * @param chain the chain to initialize.
     ...
     *
     * @param chain the chain model to remove.
     ...
     * Remove a chain from the Cilia Context.
     *
     * @param chainId the chainId model to remove.
     */
     ...
     * Stop a chain.
     *
     * @param chainId The id of the chain to stop.
     */
