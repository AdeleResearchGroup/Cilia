...
public interface Thresholds extends Node {
     ...
     * @param low
     * @param veryLow    Double.Na if for no veryLow threshold
     * @throws CiliaIllegalParameterException if variable name is null
     */
     ...
     * @param variableId variable name
     * @param high
     * @param veryhigh   Double.Na if for no threshold very high
     * @throws CiliaIllegalParameterException
     * @throws CiliaIllegalStateException
     */
