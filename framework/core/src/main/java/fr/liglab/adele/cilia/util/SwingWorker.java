...
public abstract class SwingWorker extends ThreadFactoryUser implements Runnable {
     ...
     * @throws InvocationTargetException if the constructing thread encountered an exception or was
     *                                   interrupted.
     */
     ...
     *                                   interrupted.
     */
    public Object timedGet(long msecs) throws TimeoutException, InterruptedException,
