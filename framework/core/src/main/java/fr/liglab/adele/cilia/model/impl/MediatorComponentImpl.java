...
public abstract class MediatorComponentImpl extends ComponentImpl implements
     ...
     *
     * @param id         identificator of the new mediator.
     * @param type       type of the mediator representation model.
     * @param nspace     classname of the mediator representation model.
     * @param properties new properties to add to the mediator representation model.
     * @param chain      ChainImpl where this mediator will be.
     */
     ...
     *
     * @param sched Scheduler representation model to add to the mediator.
     */
     ...
     *
     * @param disp Dispatcher representation model to add.
     */
    ...
    public String toString() {
        ...
        sb.append("\t").append("UUID : ").append(FrameworkUtils.makeQualifiedId(chainId(), nodeId(), uuid())).append(",\n");
        sb.append("\t").append("Type : ").append(getType()).append(",\n");
        sb.append("\t").append("Namespace : ").append(getNamespace()).append(",\n");
        sb.append("\t").append("ID : ").append(getId()).append(",\n");
        sb.append("\t").append("State : ").append(getState()).append(",\n");
        sb.append("\t").append("Version: ").append(getVersion()).append(",\n");
        sb.append("\t").append("Creation date :").append(Watch.formatDateIso8601(creationTimeStamp)).append("\n");
        sb.append("\t").append("Properties:").append(super.getProperties()).append("\n");
        sb.append("\t").append("}\n");
        sb.append("InPorts{\n");
        for (Object nameInPort : inPorts.keySet()) {
            sb.append("\t").append(getInPort((String) nameInPort));
        }
        sb.append("}\n");
        sb.append("OutPorts{\n");
        for (Object nameOutPort : outPorts.keySet()) {
            sb.append("\t").append(getInPort((String) nameOutPort));
        }
        sb.append("}\n");

        sb.append("Scheduler : ");
        if (this.scheduler != null) {
            sb.append(this.scheduler.getType());
        } else {
            sb.append("null");
        }
        sb.append("\n");
        ...
        if (this.dispatcher != null) {
            sb.append(this.dispatcher.getType());
        } else {
            sb.append("null");
        }
        sb.append("\n");
